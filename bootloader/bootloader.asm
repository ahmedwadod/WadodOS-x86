...
next_root_entry:
	...
	mov si, kernel_filename		; Start searching for kernel
	mov cx, 11
	rep cmpsb
...
load_file_sector:
	...
	mov ax, 0			; Set buffer past what we've already read
	mov es, ax
	mov bx, word [pointer]
...
next_cluster_cont:
    ...
    cmp ax, 0FF0h			; FF0h = end of file marker in FAT12
	jae end
...
; STRINGS AND VARIABLES
	...
	kernel_filename	db "KERNEL  BIN"	; WadodOS kernel

	disk_error	db "Floppy error! Press any key...", 0
	file_not_found	db "BOOT.BIN not found!", 0
    loaded db "Done", 0
